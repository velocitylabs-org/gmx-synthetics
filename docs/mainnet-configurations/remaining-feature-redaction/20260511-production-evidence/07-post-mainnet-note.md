...
- **Deferred follow-up:** explicit archived readback for order create/execute redaction and pool risk guard keys (out of `verifyFeaturesState.ts` scope).
